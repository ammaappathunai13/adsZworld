...
public class Y_Comedy_CustomAdapter extends RecyclerView.Adapter<Y_Comedy_CustomAdapter.MyViewHolder>  {
        ArrayList<YUsers> personNames = new ArrayList<>();
            private Comedy_Videos mListener;
        Context context;
    ...
    public void setOnItemClickListener(Comedy_Videos listener) {
        mListener =  listener;
    }

    public Y_Comedy_CustomAdapter(ArrayList<YUsers> personNames, Context context) {
    ...
    @Override
    public Y_Comedy_CustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.comedy_vid, parent, false);
        Y_Comedy_CustomAdapter.MyViewHolder vh = new Y_Comedy_CustomAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(final Y_Comedy_CustomAdapter.MyViewHolder holder, final int position) {
