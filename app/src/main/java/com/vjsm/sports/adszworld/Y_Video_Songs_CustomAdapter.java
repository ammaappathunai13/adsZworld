...
public class Y_Video_Songs_CustomAdapter extends RecyclerView.Adapter<Y_Video_Songs_CustomAdapter.MyViewHolder> {
        ArrayList<YUsers> personNames = new ArrayList<>();
            private Video_Songs mListener;
        Context context;
    ...
    public void setOnItemClickListener(Video_Songs listener) {
        mListener =  listener;
    }

    public Y_Video_Songs_CustomAdapter(ArrayList<YUsers> personNames, Context context) {
    ...
    @Override
    public Y_Video_Songs_CustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.songsvid, parent, false);
        Y_Video_Songs_CustomAdapter.MyViewHolder vh = new Y_Video_Songs_CustomAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(final Y_Video_Songs_CustomAdapter.MyViewHolder holder, final int position) {
