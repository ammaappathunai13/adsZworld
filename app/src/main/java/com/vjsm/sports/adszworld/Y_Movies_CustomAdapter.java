...
public class Y_Movies_CustomAdapter extends RecyclerView.Adapter<Y_Movies_CustomAdapter.MyViewHolder> {
        ArrayList<YUsers> personNames = new ArrayList<>();
            private Movies mListener;
        Context context;
    ...
    public void setOnItemClickListener(Movies listener) {
        mListener =  listener;
    }

    public Y_Movies_CustomAdapter(ArrayList<YUsers> personNames, Context context) {
    ...
    @Override
    public Y_Movies_CustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.moviesvid, parent, false);
        Y_Movies_CustomAdapter.MyViewHolder vh = new Y_Movies_CustomAdapter.MyViewHolder(v); // pass the view to View Holder
    ...
    @Override
    public void onBindViewHolder(final Y_Movies_CustomAdapter.MyViewHolder holder, final int position) {
